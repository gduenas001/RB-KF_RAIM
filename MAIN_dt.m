...
xlabel('time epochs'); ylabel('m');
legKF.errorx= plot(1:length(XXerrorsave), abs(XXerrorsave(1,:)),'b-','linewidth',2);
legKF.sigx= plot(1:length(PXsave), 3* sqrt(PXsave(1,:)),'--b','linewidth',2);
...
set(gca,'Yscale','log');
plot(1:length(P_HMI), P_HMI,'-b','linewidth',2);
ylim([1e-10,1e-4]);
...
save('dt01_sigw01v03','P_HMI','PXsave','XXerrorsave');
